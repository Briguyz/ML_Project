...
```
Top 12 count of actors are Dwayne Johnson (45), Samuel L. Jackson (96), Tom Hanks (52), Johnny Depp (50), Harrison Ford (50), Denzel Washington (45), Morgan Freeman (63), Robert De Niro (72), Bruce Willis (76), Meryl Streep (50), Robert Downey Jr. (44), and Tom Cruise (44).
```{r add binary column to data set for each genre}
...
```
Top 5 count of production companies are Warner Bros (643), Universal (581), 20th Century Fox (452), Paramount (465), and Columbia (435), plus Pixar (27), Marvel (51), and Walt Disney (263) for curiosity's sake. 
```{r add binary column to data set for each genre}
...
movies_df <- subset(movies_df,select=-c(genres,original_language,credits,production_companies,title))
```
